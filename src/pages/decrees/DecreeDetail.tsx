    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-6 space-y-4 max-w-5xl">
        ...
        <nav className="flex min-w-0 items-center gap-1.5 text-sm text-muted-foreground">
          ...
          <ChevronRight className="h-3.5 w-3.5" />
          <span className="text-foreground truncate max-w-[16ch] sm:max-w-[40ch]">{decree.title}</span>
        </nav>
        ...
        <div className="archive-card rounded-md p-6">
          ...
          <div className="mt-5 flex flex-wrap items-center gap-2 border-t border-border pt-4">
            ...
            <Link to="/decrees">
              <Button variant="ghost" size="sm" className="h-11 sm:h-9">{t('decrees.back')}</Button>
            </Link>
          </div>
        </div>
        ...
        <Tabs defaultValue={defaultTab}>
          ...
          {decree.fullText && (
            <TabsContent value="text" className="mt-4">
              <div className="archive-card rounded-md p-6">
                <div className="text-sm leading-8 text-foreground whitespace-pre-wrap">{decree.fullText}</div>
              </div>
            </TabsContent>
          )}
